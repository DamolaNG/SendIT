...
class ParcelController {
    constructor() {
         ...
         * POST /api/parcels
         */
        this.createParcel = async (req, res) => {
            try {
         ...
         * GET /api/parcels/:id
         */
        this.getParcelById = async (req, res) => {
            try {
                const userId = req.user?.userId;
         ...
         * PUT /api/parcels/:id
         */
        this.updateParcel = async (req, res) => {
            try {
                const userId = req.user?.userId;
                const parcelId = req.params.id;
                if (!userId) {
         ...
         */
        this.deleteParcel = async (req, res) => {
            try {
                const userId = req.user?.userId;
                const parcelId = req.params.id;
                if (!userId) {
