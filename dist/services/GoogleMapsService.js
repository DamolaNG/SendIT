...
class GoogleMapsService {
     ...
     */
    getStaticMapUrl(locations, size = '600x400') {
        const markers = locations.map((loc, index) => `markers=color:${index === 0 ? 'red' : 'blue'}|${loc.latitude},${loc.longitude}`).join('&');
